...
class AppTheme {
  ...
  static const Color accentBlue = Color(0xFF2563EB); // Можна змінити на бажаний shade
  ...
  static Color get selectedDay => secondaryGreen.shade600; // Вибраний день в календарі
